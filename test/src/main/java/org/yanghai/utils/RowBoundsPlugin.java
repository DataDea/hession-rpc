...
public class RowBoundsPlugin extends PluginAdapter {
    ...
    public RowBoundsPlugin() {
        rowBounds = new FullyQualifiedJavaType("com.github.miemiedev.mybatis.paginator.domain.PageBounds"); //$NON-NLS-1$
    ...
    private void copyAndAddMethod(Method method, Interface interfaze) {
        ...
        newMethod.setName(method.getName()); //$NON-NLS-1$
...
//        newMethod.setSynchronized(method.isSynchronized());
//        newMethod.setFinal(method.isFinal());
//        newMethod.setNative(method.isNative());
